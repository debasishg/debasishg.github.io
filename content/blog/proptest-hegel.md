...
* Choose Hegel as well when you want imperative generator code that still shrinks coherently. The official `#[hegel::composite]` docs explicitly bless feeding one draw into subsequent draws, and the this is exactly how the Hegel versions of the porcupine history generators are expressed. In Rust terms, Hegel feels most at home when your generator wants to read like straight-line business logic with branches, helper calls, local calculations, and late assumptions.
